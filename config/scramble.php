...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'This is the API documentation for the MedMart application. This is purely an inhouse API and is not intended for public use. Please contact the MedMart team for access.',
    ],
